...
prexUrl = "https://www.louisvuitton.cn/ajax/product.jsp?storeLang=zhs-cn&pageType=storelocator_section&id={}&requestingURL=";
# step1
bagUrlDetailList = []
# data
data = []
...
def getAllDetailUrls():
    originUrl = domain + "/ajax/endeca/browse-frag/women/handbags/all-handbags/_/N-1ouyuai?storeLang=zhs-cn&pageType=category&Nrpp=18&recordsPerPage=18&showColor=true&No="
