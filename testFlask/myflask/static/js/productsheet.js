...
function loadDom() {
    ...
    // (CURRENT_SKU !== DEFAULT_SKU) {
		 if (true){
      // getAjax(false, "product.jsp", callbackDomSpecificSkuLoad, {
              getAjax(false, "product", callbackDomSpecificSkuLoad, {

            id: CURRENT_SKU,
            requestingURL: 'https://www.louisvuitton.cn/zhs-cn/products/capucines-mini-capucines-nvprod300002v#N93661'
        });
        callbackDomSpecificSkuLoad()
...
function gotoOtherSku(a, b) {
    ...
    getAjax(false, "product", callbackDomSpecificSkuLoad, {
        ...
        window.location.href = "http://127.0.0.1:5000/detail?id="+a
}
